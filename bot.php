...
if(!file_exists('config.json')){
	$token = readline('1912589215:AAGEA5QJEG0ezEPEkxC0gt-iX3mFIfHY-tk: ');
	$id = readline('1774315810: ');
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/Xxx_ksomk_xxX",
                   'caption'=>' الملف مجاني وغير قابل للبيع ',
...
لشراء نسخه مراسلةة المطور ‍',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| TAHA ','url'=>'t.me/Xxx_ksomk_xxX']],
                          [['text'=>"▪️| 𝙲𝙷 ", 'url'=>"t.me/V_taha_V"]],
                      ]
                  ])
              ]);   
				}
